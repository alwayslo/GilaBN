...
cpt_HYDRO = array(data = c(1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,
                           1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,
                           1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,
                           1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1),
              dim = c(2,8,5), 
...
cpt_RECRUIT = array(data=c(0, 1, 0.7, 0.3, 0, 1, 0.9, 0.1, 0, 1, 0.7, 0.3), 
              dim= c(2,2,3),  
...
bnfit = custom.fit(dag,dist = list (TIMING = upt_TIMING,
 ...
 cpquery(bnfit,event = (RECRUIT =="YES"),evidence = list(TIMING="apr_may",INUN="bin_2",RECESSION_RATE = "bin_1"), method = "lw")
```
