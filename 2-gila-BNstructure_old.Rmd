...
cpt_INUN = t(matrix(data = c(q_prob_usgs_discrete) , nrow = 3 , ncol = 8, dimnames = list('TIMING'=c("apr_may", "jun_jul", "aug_sep"), 'INUN'=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5","bin_6","bin_7", "bin_8"))))

cpt_RECESSION_RATE = t(matrix(data = c(rr_14d_prob_usgs_discrete) , nrow = 3 , ncol = 5, dimnames = list('TIMING'=c("apr_may", "jun_jul", "aug_sep"), 'RECESSION_RATE'=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5"))))
