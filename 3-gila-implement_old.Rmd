...
natural_Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
...
```{r}
 ...
 Evidence$RECESSION_RATE<- NA
 Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
scenario1_Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
...
Evidence$RECESSION_RATE<- NA
Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
scenario2_Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
...
```{r}
write.csv(Recruit_prob,file = "output/old_natural_recruit_prob.csv")
write.csv(q_cells,file = "output/old_natural_q_cells_recruit.csv",row.names= FALSE)
```

```{r}
write.csv(Recruit_prob,file = "output/old_scenario1_recruit_prob.csv")
write.csv(q_cells,file = "output/old_scenario1_q_cells_recruit.csv",row.names= FALSE)

```

```{r}
write.csv(Recruit_prob,file = "output/old_scenario2_recruit_prob.csv")
write.csv(q_cells,file = "output/old_scenario2_q_cells_recruit.csv",row.names= FALSE)
