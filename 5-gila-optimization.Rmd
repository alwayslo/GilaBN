...
freq1<-data.frame(cart2pol(Re(mj_diff_scenario1), Im(mj_diff_scenario1),degrees = FALSE))
freq1$rownumber = 1:nrow(freq1)


freq1$koverN <- freq1$theta/(2*pi)*(1/freq1$rownumber)
