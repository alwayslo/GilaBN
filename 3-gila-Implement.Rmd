...
Evidence <- c(hydro[1:nrow(recessionrate_14d),],recessionrate_14d[,2:4])
Evidence <-data.frame(Evidence)
Evidence$TIMING <- rep("apr_may",nrow(recessionrate_14d))
Evidence$INUN <- rep("bin_4",nrow(recessionrate_14d))
Evidence$RECESSION_RATE<- rep("bin_5",nrow(recessionrate_14d))
Evidence <- setNames(Evidence, c("date","q_natural", "q_scenario1","q_scenario2","rr_natural", "rr_scenario1","rr_scenario2", "TIMING","INUN","RECESSION_RATE"))
...
write.csv(Recruit_prob,file = "/Users/lohebert/GilaBN/output/old_scenario1_recruit_prob.csv")
write.csv(q_cells,file = "/Users/lohebert/GilaBN/output/old_scenario1_q_cells_recruit.csv",row.names= FALSE)
```
