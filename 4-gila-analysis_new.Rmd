...
diffN_s2 <- cbind(r_cells_s2[1],(r_cells_s2[,3:5]-r_cells_s2[,2])*100)
diff3_s2 <- cbind(r_cells_s2[1],(r_cells_s2[,3:4]-r_cells_s2[,5])*100)
...
boxplot(r_cells_s2[,2:5],range = 1.5, main="Site 2 - Middle", ylim=c(0, 0.7),names = c("natural","Alt.E","Alt.B","Alt.A"),xlab = "scenarios",
...
boxplot(diff3_s2[,2:3],range = 1.5, main="Site 2 - Middle- Diff. from Alt.A", ylim=c(0, 0.3),names = c("Alt.E","Alt.B"),xlab = "scenarios",
