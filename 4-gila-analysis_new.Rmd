...
r_cells_s1 <- cbind(r_cells_natural_s1[,1], r_cells_natural_s1[,5],r_cells_scenario1_s1[,5],r_cells_scenario2_s1[,5],r_cells_scenario3_s1[,5])
...
r_cells_s2 <- cbind(r_cells_natural_s2[,1],r_cells_natural_s2[,5], r_cells_scenario1_s2[,5],r_cells_scenario2_s2[,5],r_cells_scenario3_s2[,5])
...
r_cells_s3 <- cbind(r_cells_natural_s3[,1],r_cells_natural_s3[,5], r_cells_scenario1_s3[,5],r_cells_scenario2_s3[,5], r_cells_scenario3_s3[,5])
...
boxplot(r_cells_s1[,3:5],main="Site 1 \n North", ylim=c(0, 0.7),names = c("1","2","3"))
boxplot(r_cells_s2[,3:5],main="Site 2 \n Middle", ylim=c(0, 0.7),names = c("1","2","3"))
boxplot(r_cells_s3[,3:5],main="Site 3 \n South", ylim=c(0, 0.7),names = c("1","2","3"))

# title("Posterior Probability of Recruitment")
