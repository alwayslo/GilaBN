...
cpt_INUN = t(matrix(data = c(q_prob_usgs_discrete) , nrow = 3 , ncol = 7, dimnames = list('TIMING'=c("apr_may", "jun_jul", "aug_sep"), 'INUN'=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5","bin_6","bin_7"))))
...
cpt_HYDRO = array(data = c(1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,
                           ...
                           1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1,
                           1,0,0.05,0.95,0.1,0.9, 0.3,0.7,0.9, 0.1),
              dim = c(2,7,5), 
