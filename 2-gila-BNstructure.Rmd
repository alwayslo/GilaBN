...
cpt_HYDRO = array(data = c(0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,0.5,
...
bnfit = custom.fit(dag,dist = list (TIMING = upt_TIMING,
 ...
 cpquery(bnfit,event = (RECRUIT =="YES"),evidence = list(TIMING="apr_may",INUN="bin_1",RECESSION_RATE = "bin_1"), method = "lw")
