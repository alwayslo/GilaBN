...
<!-- for (i in 1:(nrow(stage_cm_s2)))  -->
<!--   {usgs_recessionrate_14d <- rbind(usgs_recessionrate_14d,(stage_cm_s2[i,1]-stage_cm_s2[13+i,1])/14)} -->
...
<!-- for (i in 1:(nrow(stage_cm_s3)))  -->
<!--   {usgs_recessionrate_14d <- rbind(usgs_recessionrate_14d,(stage_cm_s3[i,1]-stage_cm_s3[13+i,1])/14)} -->
...
<!-- ##Site 2## -->
<!-- Calculates the 14-day recession rate (cm/day). Recession rate (forward) was calculated using a 14 day average based on site 2. The equation was mimicing that of Morrison & Stone (2014). -->
<!-- ```{r} -->
<!-- # average_natural_stage_14_day <-sum(head_cm_s1[1:14,1])/14 -->
<!-- # recession_rate_natural_14_day <- (head_cm_s1[1,1] - head_cm_s1[14,1])/14 -->
...
<!-- ##Site 3## -->
<!-- Calculates the 14-day recession rate (cm/day). Recession rate (forward) was calculated using a 14 day average based on site 3. The equation was mimicing that of Morrison & Stone (2014). -->
<!-- ```{r} -->
<!-- # average_natural_stage_14_day <-sum(head_cm_s1[1:14,1])/14 -->
<!-- # recession_rate_natural_14_day <- (head_cm_s1[1,1] - head_cm_s1[14,1])/14 -->
