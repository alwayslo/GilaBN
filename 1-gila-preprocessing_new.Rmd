...
# colnames(q_bin_usgs) <- c("date","q_bin_1", "q_bin_2","q_bin_3","q_bin_4","q_bin_5","q_bin_6","q_bin_7","q_bin_8")
# 
# q_prob_usgs_yr <- cbind(sum(c(q_bin_1,q_bin_2,q_bin_3,q_bin_4,q_bin_5,q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_2,q_bin_3,q_bin_4,q_bin_5,q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_3,q_bin_4,q_bin_5,q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_4,q_bin_5,q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_5,q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_6,q_bin_7), na.rm = TRUE)/length(q_bin_1),
#                         sum(c(q_bin_7), na.rm = TRUE)/length(q_bin_1))
# 
...
Calculates the probability of a bin flood event occuring for scenario 1 - current operations flow scenario for discrete time states (April-May, June-July, August-September).
```{r}                                
...
Calculates the probability of a bin flood event occuring for scenario 2 - combined operations flow scenario for discrete time states (April-May, June-July, August-September).
```{r} 
...
Calculates the probability of a bin flood event occuring for scenario 3 - combined operations+AWSA flow scenario for discrete time states (April-May, June-July, August-September).
```{r} 
