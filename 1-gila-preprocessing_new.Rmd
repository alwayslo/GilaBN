...
The hydrologic historical data for the Gila River is located in scenario_new.csv and includes the 1-natural, 2-Alt. E, 3-Alt.B , and 4-Alt.A (no action)). This code chunk loads scenario_new.csv and uses it to create a dataframe called hydro.
```{r}
