...
{recruit_natural <-rbind(recruit_natural, sum(q_prob_natural_yr[,i:15]*recruit_prob[i:15,1]))
...
{recruit_scenario1 <-rbind(recruit_scenario1, sum(q_prob_scenario1_yr[,i:15]*recruit_prob[i:7,15]))
...
```{r}
write.csv(recruit_natural,file = "output/natural_s2_recruit_prob.csv")
write.csv(q_cells, file = "output/natural_s2_q_cells_recruit.csv",row.names= FALSE)
```
