...
q_cells$recruit <-  ifelse(q_cells$bin =="bin_1",recruit_natural[1,],
                    ifelse(q_cells$bin =="bin_2",recruit_natural[2,],
                    ifelse(q_cells$bin =="bin_3",recruit_natural[3,],
                    ifelse(q_cells$bin =="bin_4",recruit_natural[4,],
                    ifelse(q_cells$bin =="bin_5",recruit_natural[5,],
                    ifelse(q_cells$bin =="bin_6",recruit_natural[6,],
                    ifelse(q_cells$bin =="bin_7",recruit_natural[7,],
                           "blah")))))))
```
...
{recruit_scenario1 <-rbind(recruit_scenario1, sum((q_prob_scenario1_yr[,i:7]*recruit[i:7,2:4])$scenario1))}
recruit_scenario1 <-dimnames( list("bin"=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5","bin_6","bin_7"),"P(R)"))
...
for (i in 1:length(q_prob_scenario2_yr))
{recruit_scenario2 <-rbind(recruit_scenario2, sum((q_prob_scenario2_yr[,i:7]*recruit[i:7,2:4])$scenario2))}
recruit_scenario2 <-dimnames( list("bin"=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5","bin_6","bin_7"),"P(R)"))
...
for (i in 1:length(q_prob_scenario3_yr))
{recruit_scenario3 <-rbind(recruit_scenario3, sum((q_prob_scenario3_yr[,i:7]*recruit[i:7,2:4])$scenario3))}
recruit_scenario3 <-dimnames( list("bin"=c("bin_1", "bin_2", "bin_3", "bin_4", "bin_5","bin_6","bin_7"),"P(R)"))
...
```{r}
write.csv(recruit_prob,file = "output/natural_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/natural_s1_q_cells_recruit.csv",row.names= FALSE)
```


The code chunck below writes output files for scenario 1.
```{r}
write.csv(recruit_prob,file = "output/scenario1_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/scenario1_s1_q_cells_recruit.csv",row.names= FALSE)
```


The code chunck below writes output files for scenario 2.
```{r}
write.csv(recruit_prob,file = "output/scenario2_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/scenario2_s1_q_cells_recruit.csv",row.names= FALSE)
```


The code chunck below writes output files for scenario 3.
```{r}
write.csv(recruit_prob,file = "output/scenario3_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/scenario3_s1_q_cells_recruit.csv",row.names= FALSE)
```
