...
Evidence$INUN <-    ifelse(Evidence$q_scenario3<= q_bin[1],"bin_1",
                    ifelse(q_bin[1]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[2],"bin_2",
                    ifelse(q_bin[2]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[3],"bin_3",
                    ifelse(q_bin[3]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[4],"bin_4",
                    ifelse(q_bin[4]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[5],"bin_5",
                    ifelse(q_bin[5]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[6],"bin_6",
                    ifelse(q_bin[6]< Evidence$q_scenario3 & Evidence$q_scenario3<=q_bin[7],"bin_7",
                    ifelse(Evidence$q_scenario3>q_bin[7],"bin_8","blah"))))))))
...
```{r}
write.csv(Recruit_prob,file = "output/nb_natural_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/nb_natural_s1_q_cells_recruit.csv",row.names= FALSE)
```

The code chunck below writes output files for scenario 1.
```{r}
write.csv(Recruit_prob,file = "output/nb_scenario1_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/nb_scenario1_s1_q_cells_recruit.csv",row.names= FALSE)
```

The code chunck below writes output files for scenario 2.
```{r}
write.csv(Recruit_prob,file = "output/nb_scenario2_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/nb_scenario2_s1_q_cells_recruit.csv",row.names= FALSE)
```

The code chunck below writes output files for scenario 3.
```{r}
write.csv(Recruit_prob,file = "output/new_scenario3_s1_recruit_prob.csv")
write.csv(q_cells,file = "output/nb_scenario3_s1_q_cells_recruit.csv",row.names= FALSE)
```
